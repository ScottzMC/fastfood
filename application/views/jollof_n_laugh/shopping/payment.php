...
<head>
    ...
    <title>Order Payment || Jollof N Laugh</title>
            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('jollof_n_laugh/view_cart'); ?>">Shopping Cart</a>
                        </li>
                                ...
                                <div class="col-lg-12">
                                    <div class="cart-shiping-update-wrapper">
                                        <div class="cart-shiping-update">
                                            <a href="<?php echo site_url('jollof_n_laugh/home/'.$company); ?>">Continue Shopping</a>
                                        </div>
                                    </div>
                                </div>
                            </div>-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="panel panel-default credit-card-box">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="<?php echo base_url('jollof_n_laugh/stripe_order_post'); ?>" method="post" 
                                    ...
                                    <input type="hidden" name="customer_email" value="<?php echo $order->email; ?>">
                                    ...
                                    <div class='form-row row'>
                                        <div class='col-xs-12 form-group card required'>
                                            ...
                                            <input autocomplete='off' class='form-control card-number' size='20' type='number' step="1" oninput="format_card_number(this)">
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-row row'>
                                        <div class='col-xs-12 col-md-4 form-group cvc required'>
                                            ...
                                            <input autocomplete='off' class='form-control card-cvc' placeholder='ex. 311' size='4' type='number' step="1" oninput="format_cvc(this)">
                                        </div>
            
                                        <div class='col-xs-12 col-md-4 form-group expiration required'>
                                            <label class='control-label'>Expiration Month</label> 
                                            <input class='form-control card-expiry-month' placeholder='MM' size='2' type='number' step="1" oninput="format_exp_month(this)">
                                        </div>
            
                                        <div class='col-xs-12 col-md-4 form-group expiration required'>
                                            <label class='control-label'>Expiration Year</label> 
                                            <input class='form-control card-expiry-year' placeholder='YYYY' size='4' type='number' step="1" oninput="format_exp_year(this)">
                                        </div>
                                    </div>
