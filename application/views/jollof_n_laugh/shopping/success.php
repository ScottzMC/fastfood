...
<head>
    ...
    <title>Successful Order || Food Delivery Collection</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!--<div class="subscribe-area bg-gray-4 pt-95 pb-95" style="margin-top: 50px;">
            <div class="container">
                <div class="col-lg-7 col-md-7" style="margin-left: 200px;">
                    <div class="subscribe-form-2" style="margin-left: 50px;">
                        <form class="validate subscribe-form-style-2" method="post" action="">
                            <div class="mc-form-2">
                                <input class="text" type="text" required="" placeholder="Enter your postcode" name="postcode" value="">
                                <div class="clear-2">
        ...
        <div class="product-area" style="margin-top: 100px;">
            <div class="container">
                <div class="border-bottom-7 hm4-pb-100">
                    <div class="section-title-tab-wrap mb-55">
                        ...
                        <div class="section-title-4">
                            ...
                            <h4>Order Total: <b>£<?php $total = $order->quantity * $order->price; echo $total; ?></b></h4>
