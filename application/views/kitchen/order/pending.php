    ...
    $(document).ready(function(){
     ...
     $('#delete_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>kitchen/delete_all",
        method:"POST",
     ...
     $('#deliver_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>kitchen/deliver_all",
        method:"POST",
        data:{checkbox_value:checkbox_value},
        success:function(){
         $('.removeRow').fadeOut(1500);
     ...
     $('#delivered_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>kitchen/delivered_all",
        method:"POST",
        data:{checkbox_value:checkbox_value},
        success:function(){
         $('.removeRow').fadeOut(1500);
     ...
     $('#cancelled_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>kitchen/cancelled_all",
        method:"POST",
        data:{checkbox_value:checkbox_value},
        success:function(){
         $('.removeRow').fadeOut(1500);
