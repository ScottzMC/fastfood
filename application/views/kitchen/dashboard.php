											...
											<table class="table display product-overview mb-30" id="support_table">
                                                ...
                                                <?php if(!empty($pending)){ foreach($pending as $pend){ ?>
													<tr>
                                                        ...
                                                        <td>
													        <button class="btn btn-info btn-icon-anim btn-square" onclick="deliveringorder(<?php echo $pend->id; ?>)" title="Delivering Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <td>
													        <button class="btn btn-success btn-icon-anim btn-square" onclick="deliveredorder(<?php echo $pend->id; ?>)" title="Delivered Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <td>
													        <button class="btn btn-danger btn-icon-anim btn-square" onclick="cancelorder(<?php echo $pend->id; ?>)" title="Cancelled Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <form action="<?php echo base_url('kitchen/make_refund'); ?>" method="POST">
											...
											<table class="table display product-overview mb-30" id="support_table">
                                                ...
                                                <?php if(!empty($delivering)){ foreach($delivering as $delving){ ?>
													<tr>
                                                        ...
                                                        <td>
													        <button class="btn btn-success btn-icon-anim btn-square" onclick="deliveredorder(<?php echo $delving->id; ?>)" title="Delivered Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <td>
													        <button class="btn btn-danger btn-icon-anim btn-square" onclick="cancelorder(<?php echo $delving->id; ?>)" title="Cancelled Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <td>
											...
											<table class="table display product-overview mb-30" id="support_table">
                                                ...
                                                <?php if(!empty($delivered)){ foreach($delivered as $delved){ ?>
													<tr>
                                                        ...
                                                        <td>
													        <button class="btn btn-success btn-icon-anim btn-square" onclick="deliveredorder(<?php echo $delved->id; ?>)" title="Delivered Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <td>
													        <button class="btn btn-danger btn-icon-anim btn-square" onclick="cancelorder(<?php echo $delved->id; ?>)" title="Cancelled Order">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </td>
                                                        <!--<td>
													     <a href="<?php echo site_url('kitchen/pending/'.$delved->id); ?>" class="btn btn-info btn-icon-anim btn-square" title="View Order">
                                                           <i class="icon-check"></i>
                                                         </a>
                                                        </td>
                                                        <td>
