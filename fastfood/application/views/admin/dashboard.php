				...
				<!-- Row -->
                    ...
                    <script>
                      function completeMessage(id){
                        ...
                        $.post('<?php echo base_url('admin/complete_message'); ?>', {"message_id": message_id}, function(data){
                          location.reload();
                          $('#cte').html(data)
                          });
                        }
											...
											<table class="table display product-overview mb-30" id="support_table">
                                                ...
                                                <?php if(!empty($message)){ foreach($message as $mess){ ?>
													<tr>
                                                        ...
                                                        <?php if($mess->status == "Pending"){ ?>
                                                        <td>
                                                         <a href="<?php echo site_url('admin/pending_message/'.$mess->id); ?>" class="btn btn-info btn-icon-anim btn-square" title="View Pending Message">
                                                           <i class="icon-check"></i>
                                                         </a>
                                                        </td> 
                                                        <?php }else if($mess->status == "Completed"){ ?>
                                                        <td>
                                                         <a href="<?php echo site_url('admin/completed_message/'.$mess->id); ?>" class="btn btn-success btn-icon-anim btn-square" title="View Completed Message">
                                                           <i class="icon-check"></i>
                                                         </a>
                                                        </td>
                                                        <?php }else if($mess->status == "Rejected"){ ?>
